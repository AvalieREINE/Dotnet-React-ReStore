import { Typography , Container, Button, ButtonGroup, Alert, AlertTitle, List, ListItem, ListItemText} from '@mui/material'
...
function AboutPage() {
  ...
  return ( 
    <Container>
      <Typography gutterBottom variant='h2'>Errors for tesing purposes</Typography>
